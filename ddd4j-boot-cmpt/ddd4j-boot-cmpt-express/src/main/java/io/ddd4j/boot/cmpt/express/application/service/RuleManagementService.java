...
public class RuleManagementService {
    ...
    private void initLocalRules() {
        ...
        registerLocalRule("contains", "字符串包含判断", "FUNCTION",
            "io.ddd4j.boot.cmpt.express.infrastructure.function.ContainsFunction", "CLASS");
        registerLocalRule("startsWith", "字符串开头判断", "FUNCTION",
            "io.ddd4j.boot.cmpt.express.infrastructure.function.StartsWithFunction", "CLASS");
        registerLocalRule("endsWith", "字符串结尾判断", "FUNCTION",
            "io.ddd4j.boot.cmpt.express.infrastructure.function.EndsWithFunction", "CLASS");
        registerLocalRule("formatDate", "日期格式化", "FUNCTION",
            "io.ddd4j.boot.cmpt.express.infrastructure.function.FormatDateFunction", "CLASS");
