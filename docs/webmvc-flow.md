...
## 全局异常映射
- 位置：`ddd4j-boot-cmpt/ddd4j-boot-cmpt-webmvc/src/main/java/io/ddd4j/boot/cmpt/webmvc/webmvc/GlobalExceptionHandler.java`
- 典型规则：
  ...
  - `ConversionNotSupportedException`/`IOException`/`IndexOutOfBoundsException`/`IllegalArgumentException` → `500`：`GlobalExceptionHandler.java:439-517`
