...
import io.ddd4j.boot.core.annotation.ApiOperationLog;
import io.ddd4j.boot.core.annotation.BusinessType;
...
public class DemoController extends BaseMapperController {
    ...
    @ApiParam(name = "demoVo", value = "xxx数据传输对象", required = true)
    ...
    @ApiParam(name = "ids", value = "ID集合，多个使用,拼接", required = true)
