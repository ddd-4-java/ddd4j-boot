...
public class MqttServerMessageListener {
    ...
    public void func3(String topic, MqttPublishMessage publishMessage, byte[] message) {
        // 记录接收到的MQTT消息信息
        log.info("topic:{} publishMessage:{} message:{}", topic, publishMessage, new String(message));
    }
