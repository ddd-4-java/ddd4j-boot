package io.ddd4j.boot.sample.order.application.dto;
...
public class OrderDTO implements Serializable {
     ...
     */
    @ApiModelProperty(value = "订单号", example = "ORD202412011200001234", required = true)
     ...
     */
    @ApiModelProperty(value = "订单状态", example = "PENDING", required = true, 
     ...
     * 订单所有商品的总金额，单位：元
     */
    @ApiModelProperty(value = "订单总金额（元）", example = "8999.00", required = true)
     ...
     * 订单支付完成的时间
     */
    @ApiModelProperty(value = "支付时间", example = "2024-12-01T12:00:00")
     ...
     * 订单发货的时间
     */
    @ApiModelProperty(value = "发货时间", example = "2024-12-02T10:00:00")
     ...
     * 订单送达的时间
     */
    @ApiModelProperty(value = "送达时间", example = "2024-12-03T15:00:00")
     ...
     * 订单创建的时间
     */
    @ApiModelProperty(value = "创建时间", example = "2024-12-01T10:00:00", required = true)
     ...
     * 订单最后更新的时间
     */
    @ApiModelProperty(value = "更新时间", example = "2024-12-01T12:00:00", required = true)
