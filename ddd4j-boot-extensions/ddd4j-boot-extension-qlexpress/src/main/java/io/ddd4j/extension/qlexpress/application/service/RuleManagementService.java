package io.ddd4j.extension.qlexpress.application.service;

import io.ddd4j.extension.qlexpress.domain.model.entity.RuleDefinition;
import io.ddd4j.extension.qlexpress.domain.model.vo.RuleValidationResult;
...
public class RuleManagementService {
    ...
    private void initLocalRules() {
        ...
        registerLocalRule("contains", "字符串包含判断", "FUNCTION",
            "io.ddd4j.extension.qlexpress.infrastructure.function.ContainsFunction", "CLASS");
        registerLocalRule("startsWith", "字符串开头判断", "FUNCTION",
            "io.ddd4j.extension.qlexpress.infrastructure.function.StartsWithFunction", "CLASS");
        registerLocalRule("endsWith", "字符串结尾判断", "FUNCTION",
            "io.ddd4j.extension.qlexpress.infrastructure.function.EndsWithFunction", "CLASS");
        registerLocalRule("formatDate", "日期格式化", "FUNCTION",
            "io.ddd4j.extension.qlexpress.infrastructure.function.FormatDateFunction", "CLASS");
