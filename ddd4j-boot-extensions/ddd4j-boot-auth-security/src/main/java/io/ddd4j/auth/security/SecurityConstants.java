...
public final class SecurityConstants {
    ...
    public static final String PAYLOAD_TENANT_ID = "tenant_id";
    public static final String PAYLOAD_ACCOUNT_ID = "uuid";
    ...
    public static final String PAYLOAD_DEPT_ID = "dept_id";
